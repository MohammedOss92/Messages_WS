...
//        });
        ...
        out1.setScroller(new Scroller(this));
        out1.setMaxLines(1);
        out1.setVerticalScrollBarEnabled(true);
        out1.setMovementMethod(new ScrollingMovementMethod());
        Intent ii=getIntent();
        input.setText(ii.getExtras().getString("name"));
...
//        }
        ...
        this.press.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                int j;
                EditTextActivity.hideSoftKeyboard(EditTextActivity.this);
                String o0 = EditTextActivity.this.input.getText().toString();
                String o3 = EditTextActivity.this.input.getText().toString();
                String o4 = EditTextActivity.this.input.getText().toString();
                String o5 = EditTextActivity.this.input.getText().toString();
                String o6 = EditTextActivity.this.input.getText().toString();
                String o7 = EditTextActivity.this.input.getText().toString();
                String o8 = EditTextActivity.this.input.getText().toString();
                String o9 = EditTextActivity.this.input.getText().toString();
                String org = EditTextActivity.this.input.getText().toString();
                ...
                EditTextActivity.this.out1.setText(org);
                EditTextActivity.this.out2.setText(o0);
                EditTextActivity.this.out3.setText(o3);
                EditTextActivity.this.out4.setText(o4);
                EditTextActivity.this.out5.setText(o5);
                EditTextActivity.this.out6.setText(o6);
                EditTextActivity.this.out7.setText(o7);
                EditTextActivity.this.out8.setText(o8);
                EditTextActivity.this.out9.setText(o9);
            }
        });
        this.copy1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out1.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share1.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out1.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out2.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share2.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out2.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out3.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share3.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out3.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out4.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out4.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out5.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share5.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out5.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out6.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share6.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out6.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out7.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share7.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out7.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy8.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out8.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share8.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out8.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
        this.copy9.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ((ClipboardManager) EditTextActivity.this.getSystemService("clipboard")).setText(EditTextActivity.this.out9.getText().toString());
                Toast.makeText(EditTextActivity.this.getBaseContext(), "\u062a\u0645 \u0646\u0633\u062e \u0645\u062d\u062a\u0648\u0649 \u0645\u0631\u0628\u0639 \u0627\u0644\u0646\u0635 \u0627\u0644\u0646\u0627\u062a\u062c", 1).show();
            }
        });
        this.share9.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent sharingIntent = new Intent("android.intent.action.SEND");
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra("android.intent.extra.TEXT", EditTextActivity.this.out9.getText().toString());
                EditTextActivity.this.startActivity(Intent.createChooser(sharingIntent, "\u0634\u0627\u0631\u0643 \u0628\u0648\u0627\u0633\u0637\u0629 :"));
            }
        });
    }
